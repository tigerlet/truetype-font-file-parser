...
class Os2AndWindowsMetrics : public TtfSubtable {
public:
...
private:
  ...
  PANOSE    panose_;
  ULong     ul_unicode_range_1_;
  ULong     ul_unicode_range_2_;
  ULong     ul_unicode_range_3_;
  ULong     ul_unicode_range_4_;
  Char      ach_vend_id_[4];
  ...
  ULong     ul_code_page_range_1_;
  ULong     ul_code_page_range_2_;
  Short     sx_height_;
  Short     s_cap_height_;
